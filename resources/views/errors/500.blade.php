<x-app-layout>
    <main class="min-h-full bg-cover bg-top sm:bg-top"
        ...
        <div class="max-w-7xl mx-auto px-4 py-16 text-center sm:px-6 sm:py-24 lg:px-8 lg:py-48">
            <p class="text-sm font-semibold text-black text-opacity-50 uppercase tracking-wide">503 error</p>
            <h1 class="mt-2 text-4xl font-extrabold text-white tracking-tight sm:text-5xl">This site will come back live in 3hours.
            </h1>
