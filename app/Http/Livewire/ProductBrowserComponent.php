...
class ProductBrowserComponent extends Component
{
    public $category;
    public $queryFilters = [];
    ...
    public function mount()
    {
        $this->queryFilters = $this->category->products
            ->pluck('variations')->flatten()->groupBy('type')
            ->keys()
    ...
    public function render()
    {
        $search=Product::search('',function($meilisearch, string $query, array $options ){
            ...
            $options['facetsDistribution']=['Weight','Measurement'];
        ...
        return view('livewire.product-browser-component',[
            'products'=>$products,
